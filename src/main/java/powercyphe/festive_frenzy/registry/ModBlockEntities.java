...
import powercyphe.festive_frenzy.block.PresentBlockEntity;

public class ModBlockEntities {

    public static BlockEntityType<PresentBlockEntity> PRESENT_BLOCK_ENTITY = registerBlockEntity("present", PresentBlockEntity::new,
